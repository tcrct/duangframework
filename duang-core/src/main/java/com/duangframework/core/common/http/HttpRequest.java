...
import com.duangframework.core.utils.ParameterHelper;
...
public class HttpRequest {
    ...
    protected FormatTypeEnums httpContentType = null;
    ...
    public FormatTypeEnums getHttpContentType() {
        return httpContentType;
    }

    public void setHttpContentType(FormatTypeEnums httpContentType) {
    ...
    public void setHttpContent(byte[] content, String encoding, FormatTypeEnums format) {
        ...
        if (null != format) {
            ...
            this.httpContentType = FormatTypeEnums.RAW;
        }
    ...
    private String getContentTypeValue(FormatTypeEnums contentType, String encoding) {
        if (null != contentType && null != encoding) {
            return FormatTypeEnums.mapFormatToAccept(contentType) +
