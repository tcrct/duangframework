...
public interface IDao<T> {
	 ...
	 * @throws Exception
	 */
	long update(MongoQuery mongoQuery, MongoUpdate mongoUpdate) throws Exception;
	 ...
	 * @return			对象
	 */
	<T> T findOne(MongoQuery mongoQuery) throws Exception;
	 ...
	 * @throws Exception
	 */
	List<T> findList(MongoQuery mongoQuery) throws Exception ;
