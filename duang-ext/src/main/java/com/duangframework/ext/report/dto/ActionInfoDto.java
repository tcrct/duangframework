package com.duangframework.ext.report.dto;

import com.duangframework.mvc.core.ValidationParam;
...
public class ActionInfoDto {
    ...
    private ValidationParam paramInfoDto; // @Mapping注解里的@Param注解对象
    ...
    public ActionInfoDto(String controllerKey, String actionKey, String desc, int level, int order, String controllerName, String methodName, ValidationParam paramInfoDto, String restfulKey, long timeout) {
    ...
    public ValidationParam getParamInfoDto() {
        return paramInfoDto;
    }

    public void setParamInfoDto(ValidationParam paramInfoDto) {
        this.paramInfoDto = paramInfoDto;
    }
